          ...
          <div className="border-t border-slate-100 dark:border-slate-800/80 pt-4">
            ...
            <div className="space-y-2">
              ...
              <button
                ...
                className="w-full flex items-center justify-between px-3 py-2.5 bg-slate-50 dark:bg-slate-950/40 rounded-xl border border-transparent dark:border-slate-800/50 active:scale-[0.98] transition-all cursor-pointer"
              >
