        ...
        <div className="flex items-center justify-between">
          ...
          {notificationsList.length > 0 && (
            <button
              ...
              className="flex items-center gap-1 px-3 py-1.5 bg-red-50 dark:bg-red-950/20 text-red-600 dark:text-red-400 rounded-xl text-xs font-semibold active:scale-95 transition-all"
            >
              <Trash2 size={13} />
              Clear
            </button>
