      ...
      <div className="px-4 py-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 shadow-sm border border-gray-100 dark:border-slate-800">
            ...
            <p className="text-xl font-bold text-gray-800 dark:text-white">90 min</p>
            <p className="text-[11px] text-gray-500 dark:text-slate-400 mt-0.5">Reporting time saved</p>
            <div className="flex items-center gap-1 mt-2">
              <TrendingUp size={10} className="text-emerald-500" />
              <span className="text-[10px] text-emerald-600 dark:text-emerald-400 font-medium">+25 min vs last week</span>
            </div>
          </div>
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 shadow-sm border border-gray-100 dark:border-slate-800">
            ...
            <div className="flex items-center gap-1 mt-2">
              <TrendingUp size={10} className="text-emerald-500" />
              <span className="text-[10px] text-emerald-600 dark:text-emerald-450 font-medium">+8 vs last week</span>
            </div>
          </div>
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 shadow-sm border border-gray-100 dark:border-slate-800">
            ...
            <p className="text-xl font-bold text-gray-800 dark:text-white">85%</p>
            <p className="text-[11px] text-gray-500 dark:text-slate-400 mt-0.5">Avg. attendance</p>
            <div className="flex items-center gap-1 mt-2">
              <TrendingUp size={10} className="text-emerald-500" />
              <span className="text-[10px] text-emerald-600 dark:text-emerald-400 font-medium">+12% improvement</span>
            </div>
          </div>
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 shadow-sm border border-gray-100 dark:border-slate-800">
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs font-bold text-gray-800 dark:text-slate-200">85%</span>
              </div>
                ...
                {impactData.weeklyImprovement.map((week, i) => (
                  <div key={i} className="flex-1 flex flex-col items-center gap-1">
                    <div className="w-full flex flex-col items-center">
                      ...
                      <div
                        className="w-full bg-sky-400 dark:bg-sky-550/80 rounded-t-lg transition-all"
        ...
        <div className="bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-slate-900/60 dark:to-slate-850/60 rounded-2xl p-4 border border-emerald-100 dark:border-slate-800">
          <div className="flex items-start gap-3">
            <div className="w-10 h-10 bg-emerald-500 rounded-xl flex items-center justify-center shrink-0">
              <Heart size={18} className="text-white" />
            </div>
            <div>
              <h4 className="text-sm font-semibold text-emerald-800 dark:text-emerald-400 mb-1">Great work, Sunita Ji!</h4>
