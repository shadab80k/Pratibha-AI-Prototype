          ...
          <>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 shadow-sm border border-gray-100 dark:border-slate-800">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-xs font-medium text-emerald-600 dark:text-emerald-450">{attendanceRate}%</span>
              </div>
                ...
                {[
                  ...
                  <div key={skill.label}>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-xs text-gray-600 dark:text-slate-350">{skill.label}</span>
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full text-xs p-2.5 border border-slate-200 dark:border-slate-850 dark:bg-slate-950 dark:text-white rounded-xl focus:border-orange-500 focus:outline-none resize-none"
                  />
                </div>
                <button
                  type="button"
