          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full text-xs p-2.5 bg-gray-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 dark:text-white rounded-xl focus:border-orange-500 focus:outline-none transition-colors"
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 shadow-sm border border-gray-100 dark:border-slate-800">
          ...
          <div className="space-y-4">
                  ...
                  <button
                    ...
                    className={`h-8 rounded-xl text-xs font-semibold select-none active:scale-95 transition-all ${
                      speed === 'Normal'
                        ...
                        : 'bg-slate-50 dark:bg-slate-950 text-slate-600 dark:text-slate-300 border border-transparent dark:border-slate-800'
                    }`}
                  >
                    {speed}
                  </button>
            ...
            <div className="flex items-center justify-between py-1">
              <span className="text-xs font-semibold text-slate-600 dark:text-slate-300">Sound Success Alerts</span>
              <button
                type="button"
